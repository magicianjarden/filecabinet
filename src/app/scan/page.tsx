    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-xl mb-8">
          <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg p-4 mb-4 shadow">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            <div className="flex-1 bg-white/80 border border-green-100 rounded-lg p-4 shadow text-slate-700 text-sm">
            ...
            <div className="flex-1 bg-white/80 border border-yellow-100 rounded-lg p-4 shadow text-slate-700 text-sm">
        ...
        <Card className="w-full max-w-xl p-8 shadow-xl border-green-200 flex flex-col bg-gradient-to-br from-green-50 to-white hover:shadow-2xl transition-shadow duration-200">
          ...
          <CardContent className="flex flex-col gap-6">
            ...
            {/* Safety tips */}
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4 text-blue-900 text-sm flex flex-col gap-2">
